...
if (localStorage.getItem('tasks')) {
	tasks = JSON.parse(localStorage.getItem('tasks'));
	tasks.forEach((task) => randarTask(task));
};
...
function addTask(e) {
	...
	tasks.push(newTask);
	// Сохраняем список ЗД в LocalStorage
	saveToLocalStorage()
...
function deleteTask(e) {
	...
	// Удалаем ЗД через фильтрацию массива
	tasks = tasks.filter((task) => task.id !== id);
